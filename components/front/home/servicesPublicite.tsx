...
function ServicesPublicite({}: Props) {
  return (
    <section className="mt-16 mb-16 section-padding bg-shikam-light py-10">
      <div className="flex items-center flex-col mb-20">
        ...
        <h2 className="text-4xl font-bold text-shikam-fonce text-center 2xl:px-64 xl:!leading-relaxed">Dominez le web : stratégies publicitaires sur mesure <span className="text-shikam-degrade">pour votre succès en ligne !</span></h2>
      </div>
        ...
        <div className="grid lg:grid-cols-2 mt-16 lg:gap-x-20">
          <div className="rounded-xl">
            <div className="rounded-t-xl">
              <Image
                src="/images/home/shikam-service-adwords.png"
                alt="Agence Shikam publicité sur les réseaux sociaux"
            ...
            <div>
              <div className="flex items-center flex-col py-10 bg-shikam-degrade-fonce lg:px-20">
                  ...
                  <p className="mb-0 font-light text-center text-slate-50">Pour sortir dans les premiers résultats de Google et Bing naturellement.</p>
          ...
          <div className="rounded-xl">
            <div>
              <div className="flex items-center flex-col py-10 bg-shikam-degrade-fonce lg:px-16">
                  ...
                  <h4 className="text-xl text-shikam-clair mb-4">Reférencement de votre site web</h4>
                  <p className="mb-0 font-light text-center text-slate-50">Pour sortir dans les premiers résultats de Google et Bing avec les annonces sponsorisées.</p>
                  <button className="text-shikam-normal bg-white px-8 py-2 rounded-full mt-4 border-2 hover:bg-shikam-normal hover:text-white transition-all duration-75 ease-in-out block">Découvrir</button>
              </div>
            </div>
            <div className="rounded-b-xl">
              <Image
                src="/images/home/shikam-service-adwords-2.png"
                alt="Agence Shikam publicité sur les réseaux sociaux"
          ...
          {/* <div className="max-w-sm rounded overflow-hidden shadow-lg">
            <div className="rounded-xl relative w-80 h-80">
              <Image
                src="/images/home/shikam-service-adwords.png"
                alt="Agence Shikam publicité sur les réseaux sociaux"
                className="object-contain rounded-t-xl"
