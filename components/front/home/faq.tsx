      ...
      <div className="grid lg:grid-cols-2">
        ...
        <div>
          <div className="flex flex-col mb-10">
            ...
            <h2 className="text-4xl font-bold text-shikam-fonce">Questions fréquentes sur <span className="text-shikam-degrade">la création et la promotion de votre site web</span></h2>
          </div>
