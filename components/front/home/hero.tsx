...
import heroImage from "../../../public/images/home/Shikam-agence-web.webp"

type Props = {}

function Hero({}: Props) {
  return (
    <section className="lg:pt-20  pt-10 pb-20 bg-shikam-light">
      <div className="container grid lg:grid-cols-7 2xl:gap-x-12 3xl:gap-x-20 gap-y-12 lg:gap-y-0 lg:place-content-between">
        <div className="col-span-4 order-2 lg:order-1">
            <h1 className="2xl:text-5xl font-bold mb-8 text-shikam-fonce lg:text-4xl text-4xl">Faites décoller votre business sur le web <span className="text-shikam-degrade">en attirant plus de client</span></h1>
            <p className="mb-6 text-lg font-light">Agence leader en création de site web et gestion de publicités sur le web pour les professionnels.</p>
            <div>
            <SiteWebForm />
            </div>
        </div>
        <div className="order-1 lg:order-2 col-span-3 justify-self-end relative w-10/12">
          <Image
          src={heroImage}
          ...
          priority
          />
          <span className="absolute -left-8 bottom-32 bg-white shadow-light py-1 px-4 text-shikam-normal font-semibold rounded-sm">Artisans</span>
          <span className="absolute -left-0 top-20 bg-white shadow-light py-1 px-4 text-shikam-normal font-semibold rounded-sm">Indépendants</span>
          <span className="absolute -right-2 bottom-32 bg-white shadow-light py-1 px-4 text-shikam-normal font-semibold rounded-sm">PME</span>
          <span className="absolute -right-0 top-28 bg-white shadow-light py-1 px-4 text-shikam-normal font-semibold rounded-md">Commerçants</span>
