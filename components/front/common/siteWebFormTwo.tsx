...
function SiteWebFormTwo({}: Props) {
  ...
  return (
    <div className="mt-8 flex flex-col items-center">
      <div className="flex mb-6 gap-x-4 justify-center">
        <button 
        className={cn("bg-shikam-light rounded-full px-4 py-2 text-sm", !openEcommerce && "bg-shikam-normal text-white")}
                ...
                <FormItem className="flex flex-col">
                    ...
                    <PopoverTrigger asChild>
                        ...
                        <Button
                            ...
                            role="combobox"
                            className={cn(
                            "max-w-xs lg:max-w-lg justify-between rounded-full h-12 bg-white border-0 text-lg shadow-light",
                            !field.value && "text-"
                            )}
                        >
                            {field.value
